...
class VideoPlayerPictureInPicture {
  static const MethodChannel _channel = MethodChannel('video_player_picture_in_picture');

  static final VideoPlayerPictureInPicturePlatformInterface _platform =
  ...
  // Singleton instance
  static final VideoPlayerPictureInPicture _instance = VideoPlayerPictureInPicture._();

  /// The shared instance of [VideoPlayerPip].
  static VideoPlayerPictureInPicture get instance => _instance;

  VideoPlayerPictureInPicture._() {
