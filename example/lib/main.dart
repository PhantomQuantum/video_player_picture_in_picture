...
class _PlayerScreenState extends State<PlayerScreen> {
  ...
  void init() async {
    try {
      ...
      _controller = VideoPlayerController.networkUrl(
        Uri.parse('https://live-hls-abr-cdn.livepush.io/live/bigbuckbunnyclip/index.mpd'),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(_debugStatus)),
      body: Stack(
        children: [
          Center(
            child: _videoInitialized
                ...
                : Column(
                    ...
                    children: [const CircularProgressIndicator(), const SizedBox(height: 20), Text(_debugStatus)],
                  ),
          ),
